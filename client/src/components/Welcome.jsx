...
const commonStyles = 'min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-[0.5px] border-gray-400 text-bold';
      ...
      <div className="flex w-full justify-center items-center">
        <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
          <div className="flex flex-1 justify-start flex-col mf:mr-10">
            ...
            <p className="text-left mt-5 text-white front-light md:w-9/12 w-11/12 text-base">Explore the crypto world. Buy and sell crytpocurrencies easily on Web3Wallet.</p>
          ...
          <div className="grid text-white sm:grid-cols-3 grid-cols-2 w-full mt-10">
            ...
            <div className={commonStyles}>Low Fees
            </div>
        ...
        {/* Right Side of Hero Seciton (Consisting Ethereum Card & Forms)  */}
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          <div className="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism">
            <div className="flex justify-between flex-col w-full h-full">
              ...
              <div>
                <p className="text-white break-all font-light text-sm">
